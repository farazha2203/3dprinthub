...
class Phase492BHeroAndLoginHotfixContractTests(SimpleTestCase):
    ...
    def test_admin_product_selection_prefills_hero_content(self):
        ...
        self.assertIn('setValue("id_title_override"', studio_js)
        self.assertIn('setValue("id_group_title"', studio_js)
        self.assertIn('setValue("id_description"', studio_js)
        self.assertIn('setValue("id_image_alt_text"', studio_js)
