...
class V854LauncherTests(unittest.TestCase):
    def test_absolute_launcher_ignores_stale_app_in_callers_working_directory(self):
        ...
        self.assertIn("EPIC49_3I29_PRODUCTS_PAGE_PAGED_48=ENABLED", result.stdout)
        self.assertIn("EPIC49_3I29_DEFERRED_GLOBAL_REFRESH=ENABLED", result.stdout)
        self.assertIn("EPIC49_3I31_SMART_LINK_AI=ENABLED", result.stdout)
        self.assertIn("EPIC49_3I31_BATCH_SELECTED_PRODUCTS_AI=ENABLED", result.stdout)
        self.assertIn("EPIC49_3I31_AI_TITLE_TEXT_ONLY=ENABLED", result.stdout)
        self.assertIn("EPIC49_3I31_AI_SELECTED_IMAGE_SEO=ENABLED", result.stdout)
