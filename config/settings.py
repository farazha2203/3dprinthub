...
ZARINPAL_REQUEST_URL = os.getenv("ZARINPAL_REQUEST_URL", "https://payment.zarinpal.com/pg/v4/payment/request.json").strip()
ZARINPAL_VERIFY_URL = os.getenv("ZARINPAL_VERIFY_URL", "https://payment.zarinpal.com/pg/v4/payment/verify.json").strip()
ZARINPAL_START_URL = os.getenv("ZARINPAL_START_URL", "https://payment.zarinpal.com/pg/StartPay/").strip()
