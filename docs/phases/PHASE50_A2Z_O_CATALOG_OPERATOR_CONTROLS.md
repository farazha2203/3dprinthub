...
- **O6B — Exact-SHA Runtime/UI Smoke — NEXT:** first verify current Qt ingestion quiescence, then one exact-SHA launch/owner-visible flow smoke and read-only post-launch integrity. STOP.
