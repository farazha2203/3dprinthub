...
O1, O1B, O2 and O2D are ACCEPTED. O2D final hardening is GitHub-exact at `4e667f4f...` on `wip/phase50-a2z-o2d-product-identity-dedup-20260924`; final exact-SHA runtime truth is 1192 raw Crawl = 707 consumed identities suppressed + 485 unconsumed Add identities (50 ready / 435 incomplete), visible mapped Products=0, canonical duplicate groups=0, queue summary parity PASS and no-mutation digest PASS. Exact next is O2E Product Media Truth/Refresh/Instagram image parity, then O2F Instagram disclosure/source+order links/Story link before O3.
