...
- [ ] O2D LOCAL_TESTED: existing Product identities are suppressed from Add Products/live candidates/batch pending/Preview/legacy queue and queue summary; anti-recrawl ledger retained; Product table/detail exposes `source_code:external_id`; final real Catalog 650 consumed hidden / 465 unconsumed visible / 47 ready + 418 incomplete / canonical duplicate groups 0; focused 51/51 + broad 131/131 + static/framework gates PASS. GitHub promotion/runtime acceptance next.
