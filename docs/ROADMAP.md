...
- [ ] O2D LOCAL_TESTED: existing Product identities are suppressed from Add Products/live candidates/batch pending/Preview; anti-recrawl ledger retained; Product table exposes `source_code:external_id`; real Catalog 625 consumed hidden / 474 unconsumed visible / canonical duplicate groups 0; focused 51/51 + broad 123/123 + static/framework gates PASS. GitHub promotion/runtime acceptance next.
