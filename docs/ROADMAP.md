...
- [ ] O6B NEXT: exact-SHA runtime/UI smoke after verifying current Catalog ingestion state/quiescence; one safe launch only, owner-visible controls + read-only post-launch integrity. STOP.
