...
- [ ] O2E CORRECTIVE_LOCAL_TESTED: initial GitHub checkpoint `a975eaaa...` exposed a real #625 selected-card omission during runtime acceptance. Corrective current-Product card synthesis is Local-tested: focused 15/15, direct Instagram publish 13/13, expanded Image/Product/Social 130/130, compile/Qt VerifyOnly/Django/no-drift/diff-check PASS. Corrective commit/push + fresh rollback + exact-SHA runtime acceptance remain.
