...
- [ ] O5G NEXT/OPTIONAL: only with explicit owner-selected Product/action to close a remaining real-provider evidence gap; #609 clickable Story remains externally blocked by Buffer mobile readiness and #301/#588 lack current Story provider evidence. Otherwise close O5G as NOT_REQUIRED/BLOCKED-EXTERNAL and proceed O6A. STOP.
