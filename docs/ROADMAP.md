...
- [ ] O5E NEXT: fresh verified Catalog rollback + isolated evidence-backed receipt reconciliation; prove exact receipt-only delta and zero Product/media/price/Site drift. No canonical write/publish. STOP.
