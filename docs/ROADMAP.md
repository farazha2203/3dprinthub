...
- [ ] O2E LOCAL_TESTED: one selected-image authority now drives Product Editor current media and Social; Refresh is local-truth/compare-only; stale/mismatched Social ACK fails closed; changed-condition 14/14 + fixture regression 20/20 + broad Image/Product/Social 99/99 + static/framework gates PASS. GitHub/runtime acceptance next.
