...
- [ ] O2H NEXT: implement guarded hard-delete for broken unconsumed Crawl identities; current Reject only changes status and is not deletion. Delete Crawl/Candidate/Preview/cache/verified candidate-derived data after rollback; Product-backed identities fail closed.
