...
- [ ] O5F NEXT: fresh rollback + re-confirm provider sent/error truth -> apply only the six clone-proven receipt finals to canonical -> prove +6 receipt-only delta, run focused/related regression + Qt runtime smoke -> docs/GitHub closure. No real repost. STOP.
