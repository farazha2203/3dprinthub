...
def variant_commerce_options_view(request):
    ...
    for variant in variants:
        ...
        payload[str(variant.pk)] = {
            ...
            "material_description": str(getattr(variant.material, "catalog_description", "") or ""),
            "material_main_usage": str(getattr(variant.material, "main_usage", "") or ""),
            "material_sample_parts": str(getattr(variant.material, "sample_parts", "") or ""),
