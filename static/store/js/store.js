document.addEventListener("DOMContentLoaded", function () {
    ...
    function updatePrice() {
        ...
        document.getElementById("variant-meta").textContent =
            `وزن مصرفی ${option.dataset.weight} گرم • زمان چاپ ${option.dataset.printTime} دقیقه • ${option.dataset.material} • ${option.dataset.quality}`;
